...
public class LoanProposalCommandListener {
    ...
    @RabbitListener(queues = RabbitMQConstants.LOAN_PROPOSAL_UPDATE_COMMAND_QUEUE, errorHandler = "globalRabbitMQExceptionHandler")
    ...
    @RabbitListener(queues = RabbitMQConstants.LOAN_PROPOSAL_DELETE_COMMAND_QUEUE, errorHandler = "globalRabbitMQExceptionHandler")
